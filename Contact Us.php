...
<body>
  ...
  <form action="includes/contactus.inc.php" name="form" method="POST" >
  ...
  <div class="container">
    <div class="content">
      <div class="left-side">
        ...
        <div class="phone details">
          ...
          <div class="text-one">+94(0)112481481</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">nexusbank1@gmail.lk</div>
          <div class="text-two">nexusbank2@gmail.lk</div>
        </div>
      </div>
	...
	<br>
      <form action="#">
        ...
        <div class="button">
          <input type="submit" value="Send Now" name="submit" class="submit">
        </div>
      </form>
    </div>
    </div>
