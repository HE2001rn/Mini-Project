...
<script>
        function processPayment() {
            ...
            var phoneNumber = document.querySelector('.customerphone').value;
            var billType = document.querySelector('.billtype').value;
            var billNumber = document.querySelector('.billnumber').value;
...
<body background="../Mini Project /images/paying-with-credit-card-online.jpg" width="460px" height="345px" class="img1">
	...
	<form>
		...
		<div class="container">
			...
			<a href="/Mini Project/PopUpMsg/BillPopUp.php"><button type="button" class="pay"> Pay </button></a>
