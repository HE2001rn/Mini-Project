...
<body background="../Mini Project/images/zenus-bank-place-city.webp" width="460px" height="345px" class="img1"><br>
	...
	<div class="rectangle">
		...
		<a href="LogOut.php"><button type="submit" class="mainlogin">Log Out</button></a>

		<ul class="navigationbar">
			<li class="navibar"><a href="About us.php">About Us</a></li>
			<li class="navibar"><a href="#careers">Careers</a></li>
	...
	<div>
		...
		<a href="Billpayment.php"><button type="button" class="button1">Pay Bills</button></a>
		<a href="Transaction.php"><button type="button" class="button2">Transaction</button></a>
		<a href="RegisterCustomerHomepage.php"><button type="button" class="button3">Account Details</button></a>
		<a href="Orderchequebooks.php"><button type="button" class="button4">Order Cheque Books</button></a>
